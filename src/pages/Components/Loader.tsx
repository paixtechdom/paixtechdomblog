...
export const Loader = () => {
    ...
    return(
        <div className={`fixed bg-gradient-to-l from-[rgba(0,0,10)] via-[rgba(0,0,24)] to-[rgba(0,0,10)] center w-full h-screen top-0 left-0 flex-col z-50 transition-all duration-[4s] opacity-${loaderOpacity}`}>
            {/* <Ladder /> */}
